...
tf.app.flags.DEFINE_string(
    'dataset_dir', '../train_images/', 'The directory where the dataset files are stored.')
...
tf.app.flags.DEFINE_integer(
    'train_image_size', None, 'Train image size,if None,it will be the models default size')
...
tf.app.flags.DEFINE_string(
    'checkpoint_path', './save_models/inception_v3.ckpt',
